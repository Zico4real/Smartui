...
def extra_tools_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        fw_status = f"{C_GREEN}active{C_RESET}" if detect_firewall() else f"{C_RED}INACTIVE{C_RESET}"
        print(f" [11]> ENABLE FIREWALL (guarded) — currently: {fw_status}")
        print("================================================================")
        print(" [0] Back")
        print("================================================================")
        ...
        if choice == '0':
            ...
            clear_screen()
            print("================================================================")
            print("           BLOCKING TORRENT, PORTS AND KEYWORDS             ")
            print("================================================================")
