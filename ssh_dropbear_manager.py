...
def ssh_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("────────────────────────────────────────────────────────────")
        print(" %s[1]>%s MODIFY SSH PORT" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s CONFIGURE SSH BANNER" % (C_YELLOW, C_RESET))
        print(" %s[3]>%s SET UP PASSWORD AND ROOT ACCESS" % (C_YELLOW, C_RESET))
        print("------------------------------------------------------------")
        print(f" {C_YELLOW}[4]>{C_RESET} START/STOP SSH SERVER [{status_label}]")
        print(" %s[5]>%s RESTART SSH SERVER" % (C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[6]%s UNINSTALL OPENSSH-SERVER" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        ...
        if choice == '0':
            ...
            print("%s════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
            print(" %s[1]%s Enable Root Login (PermitRootLogin yes)" % (C_YELLOW, C_RESET))
            print(" %s[2]%s Secure/Disable Root Login (PermitRootLogin prohibit-password)" % (C_YELLOW, C_RESET))
            print(" %s[3]%s Enable Password Authentication (PasswordAuthentication yes)" % (C_YELLOW, C_RESET))
            print(" %s[4]%s Disable Password Authentication (PasswordAuthentication no)" % (C_YELLOW, C_RESET))
...
def dropbear_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("────────────────────────────────────────────────────────────")
        print(" %s[1]>%s REDEFINING PORTS" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s MANUAL CONFIGURATION (nano)" % (C_YELLOW, C_RESET))
        print(f" {C_YELLOW}[3]>{C_RESET} START FIX WITH THE SYSTEM [{fix_status_label}]")
        print(" %s[4]>%s CONFIGURE SSH BANNER" % (C_YELLOW, C_RESET))
        print("------------------------------------------------------------")
        print(" %s[5]>%s SERVICE STATUS" % (C_YELLOW, C_RESET))
        print(" %s[6]>%s RESTART SERVICE" % (C_YELLOW, C_RESET))
        print(f" {C_YELLOW}[7]>{C_RESET} START/STOP SERVICE [{status_label}]")
        print("%s════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[8]%s UNINSTALL DROPBEAR" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
