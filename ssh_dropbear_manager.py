...
def ssh_admin_manager(ports_dict):
    ...
    while True:
        ...
        if choice == '0':
            ...
            clear_screen()
            print("════════════════════════════════════════════════════════════")
            print("              SET UP PASSWORD & ROOT ACCESS                 ")
            print("════════════════════════════════════════════════════════════")
            ...
            clear_screen()
            print("════════════════════════════════════════════════════════════")
            print("                 UNINSTALL OPENSSH-SERVER                   ")
            print("════════════════════════════════════════════════════════════")
...
def dropbear_admin_manager(ports_dict):
    ...
    while True:
        ...
        if choice == '0':
            ...
            clear_screen()
            print("════════════════════════════════════════════════════════════")
            print("                  CONFIGURE DROPBEAR BANNER                 ")
            print("════════════════════════════════════════════════════════════")
