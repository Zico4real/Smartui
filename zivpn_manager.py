...
def zivpn_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        print(" %s[1]>%s INSTALL / RECONFIGURE ZIVPN" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s MANAGE PASSWORDS (add / remove / list)" % (C_YELLOW, C_RESET))
        print(" %s[3]>%s MANUAL CONFIGURATION (nano)" % (C_YELLOW, C_RESET))
        print(" %s[4]>%s VIEW SERVICE LOGS" % (C_YELLOW, C_RESET))
        print(" %s[5]>%s RESTART SERVICE" % (C_YELLOW, C_RESET))
        print(f" {C_YELLOW}[6]>{C_RESET} START/STOP SERVICE [{status_label}]")
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[7]%s UNINSTALL ZIVPN" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        ...
        if choice == '0':
            ...
            print(" %s[1]%s Add a password" % (C_YELLOW, C_RESET))
            print(" %s[2]%s Remove a password" % (C_YELLOW, C_RESET))
