...
def checkuser_api_manager(ports_dict):
    ...
    while True:
        ...
        clear_screen()
        print("================================================================")
        print("             CHECKUSER / ACCOUNT EXPIRY API                 ")
        print("================================================================")
        ...
        if choice == '0':
            ...
            clear_screen()
            print("================================================================")
            print("                ACTIVE USER SESSIONS MONITOR                ")
            print("================================================================")
            ...
            clear_screen()
            print("================================================================")
            print("           EXPIRY API INSTALLATION WIZARD                   ")
            print("================================================================")
            ...
            clear_screen()
            print("================================================================")
            print("                CHECKUSER API SERVICE LOGS                  ")
            print("================================================================")
