...
def filebrowser_admin_manager(ports_dict):
    ...
    while True:
        ...
        clear_screen()
        print("================================================================")
        print("                    FILEBROWSER ADMINISTRATOR               ")
        print("================================================================")
        ...
        if choice == '0':
            ...
            clear_screen()
            print("================================================================")
            print("         FILEBROWSER INSTALLATION WIZARD                    ")
            print("================================================================")
            ...
            clear_screen()
            print("================================================================")
            print("                 FILEBROWSER SERVICE LOGS                   ")
            print("================================================================")
