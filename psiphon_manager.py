...
def psiphon_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        print(" %s[1]>%s ADD PSIPHON INSTANCE (creates user + provisions server)" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s LIST INSTANCES / CONNECTION INFO" % (C_YELLOW, C_RESET))
        print(" %s[3]>%s REMOVE INSTANCE" % (C_YELLOW, C_RESET))
        print(" %s[4]>%s VIEW GATE SERVICE LOGS" % (C_YELLOW, C_RESET))
        print(" %s[5]>%s RESTART GATE SERVICE" % (C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
