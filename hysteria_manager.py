...
def hysteria_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        print(" %s[1]>%s CONFIGURE / INSTALL HYSTERIA2 (Wizard)" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s SET UP PORT HOPPING RANGE" % (C_YELLOW, C_RESET))
        print(" %s[3]>%s CONFIGURE OBFS & AUTH PASSWORD" % (C_YELLOW, C_RESET))
        print(" %s[4]>%s MANUAL CONFIGURATION (nano)" % (C_YELLOW, C_RESET))
        ...
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[8]%s UNINSTALL HYSTERIA2" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
