...
def port_broker_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        print(" %s[1]>%s CONFIGURE MULTIPLEXING (Wizard)" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s VIEW CURRENT CONFIGURATION" % (C_YELLOW, C_RESET))
        print(" %s[3]>%s VIEW SERVICE LOGS" % (C_YELLOW, C_RESET))
        print(" %s[4]>%s RESTART SERVICE" % (C_YELLOW, C_RESET))
        print(" [5]> START/STOP SERVICE [%s]" % status_label)
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[6]%s UNINSTALL / DISABLE MULTIPLEXING" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
