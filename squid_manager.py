...
def squid_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        print(" %s[1]>%s CONFIGURE / INSTALL SQUID PROXY (Wizard)" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s MODIFY PROXY PORT" % (C_YELLOW, C_RESET))
        print(" %s[3]>%s MANAGE USERS (add / remove)" % (C_YELLOW, C_RESET))
        print(" %s[4]>%s EDIT SQUID CONFIGURATION (nano)" % (C_YELLOW, C_RESET))
        print(" %s[5]>%s VIEW SERVICE LOGS" % (C_YELLOW, C_RESET))
        print(" %s[6]>%s RESTART SQUID SERVICE" % (C_YELLOW, C_RESET))
        print(" [7]> START/STOP SQUID SERVICE [%s]" % status_label)
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[8]%s UNINSTALL SQUID" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s════════════════════════════════════════════════════════════════%s" % (C_CYAN, C_RESET))
        ...
        if choice == '0':
            ...
            print(" %s[1]%s Add a user" % (C_YELLOW, C_RESET))
