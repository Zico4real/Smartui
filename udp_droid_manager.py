...
def udp_droid_admin_manager(ports_dict):
    ...
    while True:
        ...
        print("----------------------------------------------------------------")
        print(" %s[1]>%s CONFIGURE / INSTALL" % (C_YELLOW, C_RESET))
        print(" %s[2]>%s MODIFY PORTS / REDIRECTION" % (C_YELLOW, C_RESET))
        ...
        print("%s================================================================%s" % (C_CYAN, C_RESET))
        print(" %s[0]%s RETURN  %s[7]%s UNINSTALL" % (C_YELLOW, C_RESET, C_YELLOW, C_RESET))
        print("%s================================================================%s" % (C_CYAN, C_RESET))
