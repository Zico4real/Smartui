...
def protocol_configuration_manager(ports_dict):
    while True:
        ...
        print(_format_cell("20", "PORT 443/80 MULTIPLEX", status_by_num["20"]))
        print(_format_cell("21", "WEBSOCKET (wstunnel)", status_by_num["21"]))
        print(_format_cell("22", "HYSTERIA 1 (LEGACY)", status_by_num["22"]))
        print(_format_cell("23", "UDP DROID (multi-port)", status_by_num["23"]))
