...
def _restart_sshgo():
    ...
    _run("systemctl reset-failed sshgo")
...
def sshgo_admin_manager(ports_dict):
    ...
    while True:
        # Same defensive re-enable as Stunnel/WS-EPRO/Atken elsewhere in
        # this panel - confirmed as a real, direct cause of a genuine bug
