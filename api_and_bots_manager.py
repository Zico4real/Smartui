...
def api_and_bots_manager():
    ...
    while True:
        clear_screen()
        print("================================================================")
        print("                  API & BOTS ADMINISTRATOR                  ")
        print("================================================================")
        print(" [1]> API INSTALLER")
        print(" [2]> TELEGRAM BOT INSTALLER")
        print(" [3]> WHATSAPP WEBHOOK RECEIVER")
        print("================================================================")
        print(" [0] Back")
        print("================================================================")
        ...
        if choice == '0':
            ...
            clear_screen()
            print("================================================================")
            print("               TELEGRAM BOT INSTALLER WIZARD                ")
            print("================================================================")
            ...
            clear_screen()
            print("================================================================")
            print("            WHATSAPP WEBHOOK RECEIVER (Meta Cloud API)      ")
            print("================================================================")
