...
def main_dashboard():
    ...
    while True:
        ...
        print(f"{C_CYAN}════════════════════════════════════════════════════════════{C_RESET}")
        print(f"{C_BOLD}{C_GREEN}           ____  __  __    _    ____ _____ _   _ ___ {C_RESET}")
        print(f"{C_BOLD}{C_GREEN}          / ___||  \\/  |  / \\  |  _ \\_   _| | | |_ _|{C_RESET}")
        print(f"{C_BOLD}{C_GREEN}          \\___ \\| |\\/| | / _ \\ | |_) || | | | | || | {C_RESET}")
        print(f"{C_BOLD}{C_GREEN}           ___) | |  | |/ ___ \\|  _ < | | | |_| || | {C_RESET}")
        print(f"{C_BOLD}{C_GREEN}          |____/|_|  |_/_/   \\_\\_| \\_\\|_|  \\___/|___|{C_RESET}")
        print(f"{C_CYAN}╔══════════════════════════════════════════════════════════╗{C_RESET}")
