...
def shadowsocks_admin_manager(ports_dict):
    ...
    while True:
        ...
        clear_screen()
        print("════════════════════════════════════════════════════════════")
        print("                SHADOWSOCKS (SS) ADMINISTRATOR              ")
        print("════════════════════════════════════════════════════════════")
        print(f"      PORT: {ss_port}")
        print("────────────────────────────────────────────────────────────")
        print(" [1]> SETUP / ADD SHADOWSOCKS INSTANCE")
        print(" [2]> MANUAL CONFIGURATION (nano)")
        print(" [3]> VIEW CONNECTION INFO / QR CODE")
        print(" [4]> VIEW SERVICE LOGS")
        print(" [5]> RESTART SHADOWSOCKS SERVICE")
        print(f" [6]> START/STOP SERVICE [{status_label}]")
        print("════════════════════════════════════════════════════════════")
        print(" [0] RETURN  [7] UNINSTALL SHADOWSOCKS")
        print("════════════════════════════════════════════════════════════")
        ...
        if choice == '0':
            ...
            clear_screen()
            print("════════════════════════════════════════════════════════════")
            print("            MANUAL SHADOWSOCKS CONFIGURATION SETUP          ")
            print("════════════════════════════════════════════════════════════")
            ...
            clear_screen()
            print("════════════════════════════════════════════════════════════")
            print("                SHADOWSOCKS CONNECTION DETAILS              ")
            print("════════════════════════════════════════════════════════════")
            if os.path.exists(SS_CONFIG_PATH):
                with open(SS_CONFIG_PATH, "r") as f:
                    cfg = json.load(f)
            ...
            clear_screen()
            print("════════════════════════════════════════════════════════════")
            print("                SHADOWSOCKS SERVICE LOGS                    ")
            print("════════════════════════════════════════════════════════════")
